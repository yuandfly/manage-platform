/* KindEditor 4.1.10 (2014-06-10), Copyright (C) kindsoft.net, Licence: http://kindeditor.net/license.php */ ! function (window, undefined) {
  function _isArray(a) {
  ...
  function _addUnit(a, b) {
    return b = b || "px", a && /^\d+$/.test(a) ? a + b : a
  }
  ...
  function _bind(a, b, c) {
    if (b.indexOf(",") >= 0) return _each(b.split(","), function () {
      _bind(a, this, c)
    }), void 0;
    var d = _getId(a);
  ...
  function _unbind(a, b, c) {
    if (b && b.indexOf(",") >= 0) return _each(b.split(","), function () {
      _unbind(a, this, c)
    }), void 0;
    var d = _getId(a);
    if (d) {
      if (b === undefined) return d in _eventData && (_each(_eventData[d], function (b, c) {
        "el" != b && c.length > 0 && _unbindEvent(a, b, c[0])
      }), delete _eventData[d], _removeId(a)), void 0;
      if (_eventData[d]) {
        var e = _eventData[d][b];
        if (e && e.length > 0) {
  ...
  function _ready(a) {
    ...
    function c() {
      if (!e) {
        try {
          ...
          return setTimeout(c, 100), void 0
        }
        b()
      }
    }
    ...
    if (_readyFinished) return a(KindEditor), void 0;
    var e = !1;
  ...
  function _queryAll(a, b) {
    ...
    for (v = 0, lenth = n.length; lenth > v; v++)
      if (q = n[v], ">" !== q) {
        if (v > 0) {
  ...
  function _plugin(a, b) {
    return a === undefined ? _plugins : b ? (_plugins[a] = b, void 0) : _plugins[a]
  }
  ...
  function _bindContextmenuEvent() {
    ...
    K(b).contextmenu(function (b) {
      if (a.menu && a.hideMenu(), !a.useContextmenu) return b.preventDefault(), void 0;
      if (0 !== a._contextmenus.length) {
        var c = 0,
          d = [];
        for (_each(a._contextmenus, function () {
            return "-" == this.title ? (d.push(this), void 0) : (this.cond && this.cond() && (d.push(this), this.width && this.width > c && (c = this.width)), void 0)
    ...
    if (!(_IE && "br" !== d || _GECKO && 3 > _V && "p" !== d || _OPERA && 9 > _V)) {
      ...
      K(c).keydown(function (g) {
        if (!(13 != g.which || g.shiftKey || g.ctrlKey || g.altKey)) {
          b.cmd.selection();
          var h = a(b.cmd.range);
          if ("marquee" != h && "select" != h) return "br" !== d || e[h] ? (f[h] || _nativeCommand(c, "formatblock", "<p>"), void 0) : (g.preventDefault(), b.insertHtml("<br />" + (_IE && 9 > _V ? "" : "​")), void 0)
        }
        ...
        if (!(13 != e.which || e.shiftKey || e.ctrlKey || e.altKey) && "br" != d) {
          if (_GECKO) {
            ...
            return h && "" == h.text() && (h.remove(!0), b.cmd.range.selectNodeContents(g[0]).collapse(!0), b.cmd.select()), void 0
          }
          b.cmd.selection();
          var i = a(b.cmd.range);
  ...
  function _bindTabEvent() {
    ...
    K(b).keydown(function (c) {
      if (9 == c.which) {
        if (c.preventDefault(), a.afterTab) return a.afterTab.call(a, c), void 0;
        var d = a.cmd,
          e = d.range;
  ...
  function _addBookmarkToStack(a, b) {
    if (0 === a.length) return a.push(b), void 0;
    var c = a[a.length - 1];
  ...
  if (!window.KindEditor) {
    ...
    K = function (a, b) {
      ...
      if (a !== undefined && null !== a) {
        ...
        return a && a.constructor === KNode ? a : (a.toArray && (a = a.toArray()), _isArray(a) ? c(a) : c(_toArray(arguments)))
      }
    ...
    _extend(KRange, {
      ...
      wrap: function (a) {
        ...
        return K(i).scan(function (a) {
          if (!j && a == h.start) return j = !0, void 0;
          if (j) {
            if (a == h.end) return !1;
            var c = K(a);
      ...
      remove: function (a) {
        ...
        K(d.commonAncestor()).scan(function (a) {
          return o || a != l ? a == m ? !1 : (o && n.push(a), void 0) : (o = !0, void 0)
    ...
    (html = document.getElementsByTagName("html")) && (_direction = html[0].dir), _extend(KEdit, KWidget, {
      ...
      design: function (a) {
        var b, c = this;
        return (a === undefined ? !c.designMode : a) ? c.designMode || (b = c.html(), c.designMode = !0, c.html(b), c.textarea.hide(), c.iframe.show()) : c.designMode && (b = c.html(), c.designMode = !1, c.html(b), c.iframe.hide(), c.textarea.show()), c.focus()
      },
      focus: function () {
        var a = this;
      ...
      addItem: function (a) {
        var b = this;
        if ("-" === a.title) return b.div.append(K('<div class="ke-menu-separator"></div>')), void 0;
    ...
    KEditor.prototype = {
      ...
      loadPlugin: function (a, b) {
        var c = this;
        return _plugins[a] ? _isFunction(_plugins[a]) ? (_plugins[a].call(c, KindEditor), b && b.call(c), c) : (setTimeout(function () {
          c.loadPlugin(a, b)
      ...
      create: function () {
        function a() {
          return 0 === i.height() ? (setTimeout(a, 100), void 0) : (b.resize(d, e, !1), void 0)
        }
        var b = this,
          c = b.fullscreenMode;
      ...
      _each("undo,redo".split(","), function (a, d) {
        ...
        a(g.body).bind("paste", function (j) {
          if (0 === b.pasteType) return j.stop(), void 0;
          if (!i) {
            ...
            } else d.range.selectNodeContents(f[0]), d.select();
            setTimeout(function () {
              c(), i = !1
            }, 0)
          }
        ...
        f = b.createDialog({
          ...
          yesBtn: {
            ...
            click: function () {
              ...
              return "" === a.trim(e) ? (alert(d.pleaseInput), g[0].focus(), void 0) : (b.insertHtml(i).hideDialog().focus(), void 0)
            }
          }
        }),
        g = a("textarea", f.div);
    ...
    d.plugin.filemanagerDialog = function (b) {
      ...
      function j(b, c, d, e) {
        ...
        d.is_dir ? b.click(function () {
          i(g, y.val(), e)
        }) : d.is_photo ? b.click(function () {
            ...
            yesBtn: {
              ...
              click: function () {
                var c = a.trim(n.val()),
                  d = p.val(),
                  e = q.val();
                if ("http://" == c || a.invalidUrl(c)) return alert(b.lang("invalidUrl")), n[0].focus(), void 0;
                if (!/^\d*$/.test(d)) return alert(b.lang("invalidWidth")), p[0].focus(), void 0;
                if (!/^\d*$/.test(e)) return alert(b.lang("invalidHeight")), q[0].focus(), void 0;
    ...
    var b = this,
      ...
      h = a.undef(b.uploadJson, b.basePath + "/web-api/upload/kindUploadFile"),
      ...
      var u, v = ['<div style="padding:20px;">', '<div class="tabs"></div>', '<div class="tab1" style="display:none;">', '<div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' + n.remoteUrl + "</label>", '<input type="text" id="remoteUrl" class="ke-input-text" name="url" value="" style="width:200px;" /> &nbsp;', '<span class="ke-button-common ke-button-outer">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + n.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="remoteWidth" style="width:60px;">' + n.size + "</label>", n.width + ' <input type="text" id="remoteWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> ', n.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> ', '<img class="ke-refresh-btn" src="' + j + 'refresh.png" width="16" height="16" alt="" style="cursor:pointer;" title="' + n.resetSize + '" />', "</div>", '<div class="ke-dialog-row">', '<label style="width:60px;">' + n.align + "</label>", '<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /> <img name="defaultImg" src="' + j + 'align_top.gif" width="23" height="25" alt="" />', ' <input type="radio" name="align" class="ke-inline-block" value="left" /> <img name="leftImg" src="' + j + 'align_left.gif" width="23" height="25" alt="" />', ' <input type="radio" name="align" class="ke-inline-block" value="right" /> <img name="rightImg" src="' + j + 'align_right.gif" width="23" height="25" alt="" />', "</div>", '<div class="ke-dialog-row">', '<label for="remoteTitle" style="width:60px;">' + n.imgTitle + "</label>", '<input type="text" id="remoteTitle" class="ke-input-text" name="title" value="" style="width:200px;" />', "</div>", "</div>", '<div class="tab2" style="display:none;">', '<iframe name="' + r + '" style="display:none;"></iframe>', '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + r + '" action="' + h + '">', '<div class="ke-dialog-row">', s.join(""), '<label style="width:60px;">' + n.localUrl + "</label>", '<input type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:200px;" readonly="true" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + n.upload + '" />', "</div>", "</form>", "</div>", "</div>"].join(""),
        ...
        y = b.createDialog({
          ...
          yesBtn: {
            ...
            click: function () {
              if (!y.isLoading) {
                if (o && i && u && 1 === u.selectedIndex || !i) return "" == I.fileBox.val() ? (alert(b.lang("pleaseSelectFile")), void 0) : (y.showLoading(b.lang("uploadLoading")), I.submit(), B.val(""), void 0);
                var c = a.trim(A.val()),
                  d = D.val(),
                  e = E.val(),
                  f = G.val(),
                ...
                }), "http://" == c || a.invalidUrl(c) ? (alert(b.lang("invalidUrl")), A[0].focus(), void 0) : /^\d*$/.test(d) ? /^\d*$/.test(e) ? (q.call(b, c, f, d, e, 0, g), void 0) : (alert(b.lang("invalidHeight")), E[0].focus(), void 0) : (alert(b.lang("invalidWidth")), D[0].focus(), void 0)
              }
            }
          },
          beforeRemove: function () {
        ...
        p = b.createDialog({
          ...
          yesBtn: {
            ...
            click: function () {
              var c = a.trim(r.val()),
                d = t.val();
              return "http://" == c || a.invalidUrl(c) ? (alert(b.lang("invalidUrl")), r[0].focus(), void 0) : ("" === a.trim(d) && (d = c), n.call(b, c, d), void 0)
            }
          }
        }),
        q = p.div,
        ...
        var d = b.lang(c + "."),
          ...
          f = b.createDialog({
            ...
            yesBtn: {
              ...
              click: function () {
                var c = a.trim(h.val());
                return "http://" == c || a.invalidUrl(c) ? (alert(b.lang("invalidUrl")), h[0].focus(), void 0) : (b.exec("createlink", c, i.val()).hideDialog().focus(), void 0)
              }
            }
          }),
          g = f.div,
      ...
      init: function (b) {
        ...
        var e = {
          ...
          upload_success_handler: function (b, e) {
            ...
            return 0 !== g.error ? (c(f, a.DEBUG ? g.message : d.options.errorMessage), void 0) : (b.url = g.url, a(".ke-img", f).attr("src", b.url).attr("data-status", b.filestatus).data("data", g), a(".ke-status > div", f).hide(), void 0)
          }
        };
            ...
            yesBtn: {
              ...
              click: function () {
                var b = m.val(),
                  ...
                  A = a(w[0]).html() || "",
                  B = a(w[1]).html() || "";
                if (0 == b || !/^\d+$/.test(b)) return alert(e.lang("invalidRows")), m[0].focus(), void 0;
                if (0 == c || !/^\d+$/.test(c)) return alert(e.lang("invalidRows")), n[0].focus(), void 0;
                if (!/^\d*$/.test(d)) return alert(e.lang("invalidWidth")), o[0].focus(), void 0;
                if (!/^\d*$/.test(f)) return alert(e.lang("invalidHeight")), p[0].focus(), void 0;
                if (!/^\d*$/.test(k)) return alert(e.lang("invalidPadding")), s[0].focus(), void 0;
                if (!/^\d*$/.test(l)) return alert(e.lang("invalidSpacing")), t[0].focus(), void 0;
                if (!/^\d*$/.test(z)) return alert(e.lang("invalidBorder")), v[0].focus(), void 0;
            ...
            yesBtn: {
              ...
              click: function () {
                ...
                return /^\d*$/.test(b) ? /^\d*$/.test(c) ? /^\d*$/.test(j) ? (v.css({
                  ...
                  "border-color": u
                }), e.hideDialog().focus(), e.cmd.range.moveToBookmark(h), e.cmd.select(), e.addBookmark(), void 0) : (alert(e.lang("invalidBorder")), s[0].focus(), void 0) : (alert(e.lang("invalidHeight")), l[0].focus(), void 0) : (alert(e.lang("invalidWidth")), k[0].focus(), void 0)
              }
            }
          }),
          j = i.div,
