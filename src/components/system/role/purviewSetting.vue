<template>
  <el-dialog title="权限设置"
    ...
    关键字搜索&nbsp;&nbsp;&nbsp;&nbsp;<el-input placeholder="请输入关键字搜索"
                                           class="myselect" v-model="filterText"></el-input>
    <el-tree class="filter-tree"
      ...
      <div slot="footer"
           class="dialog-footer"
           id="el-dialog__footer">
        <el-button @click.native="close">取消</el-button>
        <el-button type="primary"
                   @click.native="ztreeSubmit">提交</el-button>
      </div>
  </el-dialog>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    initData: function () {
      ...
      // 初始化时，父子不互相关联
      this.associate = true
      getRolePerTree(this.roleId).then(res => {
    ...
    ztreeSubmit: function () {
      ...
      this.$confirm('确认提交吗？', '提示', {}).then(() => {
        this.$axios.get('/web-api/web/permission/updatePermissByRoleId?roleId=' + roleId, {
